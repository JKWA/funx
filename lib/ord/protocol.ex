defprotocol Funx.Ord.Protocol do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Funx.Ord.Protocol.lt?(Funx.Monad.Maybe.just(3), Funx.Monad.Maybe.just(5))
      true
  ...
  ## Examples
      ...
      iex> Funx.Ord.Protocol.le?(Funx.Monad.Maybe.just(3), Funx.Monad.Maybe.just(5))
      true
  ...
  ## Examples
      ...
      iex> Funx.Ord.Protocol.gt?(Funx.Monad.Maybe.just(5), Funx.Monad.Maybe.just(3))
      true
  ...
  ## Examples
      ...
      iex> Funx.Ord.Protocol.ge?(Funx.Monad.Maybe.just(5), Funx.Monad.Maybe.just(3))
      true
...
defimpl Funx.Ord.Protocol, for: Any do
...
defimpl Funx.Ord.Protocol, for: DateTime do
...
defimpl Funx.Ord.Protocol, for: Date do
...
defimpl Funx.Ord.Protocol, for: Time do
...
defimpl Funx.Ord.Protocol, for: NaiveDateTime do
